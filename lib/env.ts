...
const envSchema = z.object({
  ...
  LANGFUSE_BASE_URL: optionalTrimmedString,
  ...
  FEED_HYBRID_SEEN_ENABLED: optionalBooleanString,
  SEEN_PROFILE_DUAL_WRITE_ENABLED: optionalBooleanString,
  ENGAGEMENT_SERVER_BATCH_ENABLED: optionalBooleanString,
  FEED_PERSISTENT_CACHE_ENABLED: optionalBooleanString,
  NEXT_PUBLIC_FEED_PERSISTENT_CACHE_ENABLED: optionalBooleanString,
  ...
  DEEPL_API_KEY: optionalTrimmedString,
  DEEPL_API_URL: optionalTrimmedString,
